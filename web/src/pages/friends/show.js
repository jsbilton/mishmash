            ...
            <div>
              ...
              {this.state.showconfirm ? null : <div className="fw1 tc san francisco">
                ...
                <article className="mw5 center bg-white br3 pa3 pa4-ns mv3 ba b--black-10 shadow-5">
                  ...
                  {/* <p className="fw1 f2 tc san francisco">{this.state.friend.name}</p>
                  ...
                  <p className="f3 tc">
                    ...
                    {/* <nav>
                      <Link to={`/friends/${this.state.friend._id}/edit`} className="f6 grow no-underline br-pill ba bw2 ph3 pv2 mb2 dib dark-blue" href="#0">Update </Link>
                      <a href="#" onClick={this.handleRemove}>Remove {this.state.friend.name}</a>
